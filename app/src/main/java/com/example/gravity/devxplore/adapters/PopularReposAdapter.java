...
public class PopularReposAdapter extends RecyclerView.Adapter<PopularReposAdapter.RepoViewHolder> {
    ...
    public PopularReposAdapter(Context context, List<Repository> repositories, RepoAdapterListener listener) {
    ...
    @NonNull
    @Override
    public PopularReposAdapter.RepoViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
